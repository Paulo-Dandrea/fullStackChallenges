...
const sendMarsTemperature = (callbackGetTemp, callbackMessadelay) => {
  setTimeout(() => {console.log(callbackGetTemp());}, callbackMessadelay());
};

sendMarsTemperature(getMarsTemperature, messageDelay); // imprime "Mars temperature is: 20 degree Celsius", por exemp
